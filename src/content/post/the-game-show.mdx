...
<CldImage
  src="https://res.cloudinary.com/paulapplegate-com/image/upload/v1728677724/lfpxvwsaqmzfxjov8fmq.jxl"
  width="1920"
  height="1244"
...
<Image src={myImage} alt="This will use responsive layout" width={800} height={600} layout="responsive" />

<Image src={planet} alt="This will use responsive layout" width={1000} height={800} layout="responsive" />
...
<CldImage
  src="https://res.cloudinary.com/paulapplegate-com/image/upload/v1728678424/xm75ykzvmh8uhjuvp0mg.jxl"
  width="1920"
  height="1950"
  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
  alt="A game show"
...
<CldImage
  src="https://res.cloudinary.com/paulapplegate-com/image/upload/v1728677949/krrbtrqwo9fjafxzigc8.jxl"
  width="1222"
  height="1600"
  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
  alt="A game show"
